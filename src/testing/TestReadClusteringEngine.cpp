...
std::string TestReadClusteringEngine::cluster_consistency(GenomeReadCluster *cluster) {
...
void TestReadClusteringEngine::print_clusters(int first_n) {
...
void TestReadClusteringEngine::run_clustering() {
...
void TestReadClusteringEngine::construct_read_category_map(SequenceRecordIterator &read_iterator) {
    read_iterator.reset();
...
TestReadClusteringEngine::TestReadClusteringEngine(SequenceRecordIterator &read_iterator, std::set<Kmer> &characteristic_kmers, int k) : ReadClusteringEngine(read_iterator,
                                                                                                                                                              characteristic_kmers,
                                                                                                                                                              k) {
    construct_read_category_map(read_iterator);
}
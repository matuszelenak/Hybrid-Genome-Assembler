...
def simulate_perfect_reads(sequence_record, read_length=200, coverage=30):
    sequence = str(sequence_record.seq)
...
for seq_record in loaded_sequences:
    mixed_reads += simulate_perfect_reads(seq_record, read_length=args.r, coverage=args.c)
